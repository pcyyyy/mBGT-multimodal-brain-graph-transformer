...
from ..modules import init_params, MbgtGraphEncoder
...
@register_model("mbgt")
class MbgtModel(FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--apply-init",
            action="store_true",
            help="use custom param initialization for Mbgt",
        )
...
class MbgtEncoder(FairseqEncoder):
    def __init__(self, args):
        super().__init__(dictionary=None)
        self.max_nodes = args.max_nodes


        self.graph_encoder = MbgtGraphEncoder(
...
@register_model_architecture("mbgt", "mbgt")
...
@register_model_architecture("mbgt", "mbgt_base")
def mbgt_base_architecture(args):
